...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': 'yourjwtsecraaaaaaaaaaaaaaaaaaaaaaaddsasasasasasasasasasasaassaet ',  # Replace with your secret key
    'VERIFYING_KEY': None,
    'AUDIENCE': None,
    'ISSUER': None,
...
SECRET_KEY = 'django-insecure-qq4il^2mvj(u8zq+f7@5j31+*fo7g$6*kox98q8xwp*k7q7*03'
